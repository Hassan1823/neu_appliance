...
const NewsLetterSection = () => {
  return (
    <div id="news" className='flex justify-center items-center h-auto py-16 lg:px-[8.33%] px-2' >
      <div id="news-grid" className='lg:grid grid-cols-12 flex flex-col justify-center items-center py-5 bg-b4 w-full lg:h-72 xl:h-96 h-auto rounded-lg gap-4' >
     ...
     <div className='col-start-7 col-end-12 flex flex-col space-y-2' >
      <h4 className='font-bold text-sm mx-auto' >Email</h4>
