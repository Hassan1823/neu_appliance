...
const MapSection = () => {
  ...
  return (
    <div className="lg:inline hidden">
      <h4 className="font-bold text-center xl:text-3xl lg:text-2xl mt-10">
        Neu Local Delivery Area
      </h4>
      <div className="relative flex flex-col justify-end items-end py-20 w-[1440px] h-[686px] px-5">
        <img
          src="./free.png"
          className="absolute z-40 xl:top-0 xl:w-52 xl:right-10 lg:w-36 w-20 lg:top-5 top-10 right-0 lg:right-8"
        />

        <div
          className={`absolute bottom-20 lg:left-24 ${
            success ? "flex" : "hidden"
          } items-center z-20 bg-transparent h-52 justify-center w-11/12`}
        >
        ...
        <div
          className={`absolute bottom-10 left-24 ${
            error ? "flex" : "hidden"
          } items-center z-20 bg-transparent h-52 justify-end w-12/12`}
        >
        ...
        <div
          id="map"
          className="xl:h-[686px] xl:w-[1000px] lg:h-[490px] lg:w-[850px] w-full h-52 rounded-2xl"
        ></div>
        {/* Map Section End */}
